...
const file_crawler_proto_rawDesc = "" +
	"\n" +
	"\rcrawler.proto\x12\x02pb\"\"\n" +
	"\x0eCrawlerRequest\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03urlB&Z$github.com/pule1234/VideoForge/pb;pbb\x06proto3"
...
var file_crawler_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_crawler_proto_goTypes = []any{
	(*CrawlerRequest)(nil), // 0: pb.CrawlerRequest
}
